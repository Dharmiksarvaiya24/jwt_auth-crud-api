        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {flights.map((flight) => (
              ...
              <p className="text-gray-600">To: {flight.arrival}</p>
	                ...
	                <button onClick={handeleedit} className="cursor-pointer flex items-center gap-2 text-blue-600">
	                  <img
	                ...
	                <button onClick={handeledel} className="cursor-pointer flex items-center gap-2 text-red-600">
	                  <img
